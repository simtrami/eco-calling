<nav id="nav"
    ...
    <button id="nav-toggler" class="mx-3 md:hidden" type="button">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 text-theme" fill="none" viewBox="0 0 24 24"
             stroke="currentColor">
    ...
    md:items-center md:text-left md:bg-transparent md:text-theme">
        <ul class="font-body font-medium flex flex-col list-none space-y-5 pl-0 py-6 mx-auto
